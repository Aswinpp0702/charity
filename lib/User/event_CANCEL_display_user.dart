...
class user_event_CANCEL_display extends StatefulWidget {
  const user_event_CANCEL_display({Key? key}) : super(key: key);

  @override
  State<user_event_CANCEL_display> createState() => _user_event_CANCEL_displayState();
}

class _user_event_CANCEL_displayState extends State<user_event_CANCEL_display> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Cancel Events",style: TextStyle(color: Colors.white),),
        //centerTitle: true,
                                    ...
                                    trailing: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                         ...
                                         Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>user_event_CANCEL_display()));
                                        });
