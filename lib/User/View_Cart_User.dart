...
,                        Align(
                            ...
                            child: GestureDetector(
                              ...
                              onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context)=>Payment_User(
                                   cart_data: access_total_amt)));
                              },
                              //cart_data: access_total_amt,
                            )),
                      ],),
  ...
  Future<void> delrecord(String id) async {
    String url =
        "http://$ip_address/charity_HOPE/user_remove_cart_items.php";
