...
class admin_edit_events_display extends StatefulWidget {
  const admin_edit_events_display({Key? key}) : super(key: key);

  @override
  State<admin_edit_events_display> createState() => _admin_edit_events_displayState();
}

class _admin_edit_events_displayState extends State<admin_edit_events_display> {
